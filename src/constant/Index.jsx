...
<>
<div className='bg-red-600 h-72 w-72 rounded-xl mt-20'>
      <div className='p-5'>
    ...
    <div className='bg-orange-600 h-72 w-72 rounded-xl mt-20'>
      <div className='p-5'>
    ...
    <div className='bg-purple-600 h-72 w-72 rounded-xl mt-20'>
      <div className='p-5'>
    ...
    <div className='bg-yellow-600 h-72 w-72 rounded-xl mt-20'>
      <div className='p-5'>
    ...
    <div className='bg-blue-600 h-72 w-72 rounded-xl mt-20'>
      <div className='p-5'>
    ...
    <div className='bg-green-500 h-72 w-72 rounded-xl mt-20'>
      <div className='p-5'>
    ...
    <button className="border border-black text-white bg-black px-5 py-2 rounded-xl font-semibold  mt-3">Add to Cart</button>
